...
db.serialize(() => {
    db.run("CREATE TABLE IF NOT EXISTS payments (pid TEXT, sid TEXT, aid TEXT, qty NUMERIC, email TEXT, license TEXT, json TEXT, dt TIMESTAMP DEFAULT CURRENT_TIMESTAMP)")
